...
SCIENCE_DATA = {
    ...
    "hydration": {
        ...
        "benefits": [
            ...
            "Помощь в регуляции температуры",
...
MISSION_TITLES = {
    "sleep": "Хорошо выспаться сегодня",
    "exercise": "Двигать телом",
    "family": "Провести время с семьей",
    "deep_work": "Глубокая работа",
    "hydration": "Поддерживать гидратацию"
}

MISSION_DESCRIPTIONS = {
    "sleep": "Приоритет качественного сна для оптимального здоровья и эффективности",
    "exercise": "Физическая активность для улучшения вашего здоровья",
    "family": "Проведение значимого времени с близкими",
    "deep_work": "Сосредоточиться на важных задачах без отвлечений",
